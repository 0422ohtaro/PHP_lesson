...
$patient = new Patient("ohtaro", 36, "men", 1.89, 67);

echo "{$patient->getName()}さんの身長は{$patient->getHeight()}mなので
平均体重は{$patient->calculateStandardWeight()}kgです。
現在の体重は{$patient->getWeight()}kgです。";
